...
app = Client(
    "RikkyUserBot",
    api_id=12953876,
    api_hash="a28c1c91feee54274c0a4779410a58b3"
)
...
<a href="https://GitHub.com/">GitHub проекта</a>
<a href="https://telegra.ph/">Список команд</a>
...
def test(app, message):
    #app.send_message(message.chat.id, 'ладно')
    message.reply('<a href="https://vk.com/id41732290">VK</a>', disable_web_page_preview=True) # ссылка в тексте
